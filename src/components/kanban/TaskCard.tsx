...
export default function TaskCard({ task, onClick }: TaskCardProps) {
  ...
  return (
    <div
      ...
      style={style}
      onClick={onClick}
      className="group relative bg-slate-800/90 hover:bg-slate-800 border border-slate-700/60 hover:border-slate-600 rounded-xl p-3.5 shadow-sm hover:shadow-md transition-all cursor-pointer select-none"
    >
